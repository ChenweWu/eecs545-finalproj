...
DATA_BASE_DIR = os.path.join(os.path.dirname(
    os.path.abspath(__file__)), "/scratch/bcde/zyang2/data")
...
# Created csv
MIMIC_CXR_SZT_DATA_DIR = DATA_BASE_DIR / "raw/physionet.org/files/mimic-cxr-jpg-szt/2.0.0"
MIMIC_CXR_TRAIN_CSV = MIMIC_CXR_SZT_DATA_DIR / "train.csv"
MIMIC_CXR_VALID_CSV = MIMIC_CXR_SZT_DATA_DIR / "test.csv"
MIMIC_CXR_TEST_CSV = MIMIC_CXR_SZT_DATA_DIR / "test.csv"
MIMIC_CXR_MASTER_CSV = MIMIC_CXR_SZT_DATA_DIR / "master.csv" 
MIMIC_CXR_MASTER_RACE_CSV = MIMIC_CXR_SZT_DATA_DIR / "multiclass.csv" 
MIMIC_CXR_MASTER_NO_RACE_CSV = MIMIC_CXR_SZT_DATA_DIR / "merged_without_race.csv" 
MIMIC_CXR_MASTER_RACE_FILTER_CSV = MIMIC_CXR_SZT_DATA_DIR / "multiclass.csv" 
...
# #############################################
# Chest ImaGenome constants
# #############################################
CHEST_IMAGENOME_DATA_DIR = DATA_BASE_DIR / "raw/physionet.org/files/chest-imagenome-szt/1.0.0"
##Silver
CHEST_IMAGENOME_SILVER_DATA = CHEST_IMAGENOME_DATA_DIR / "silver_dataset"
CHEST_IMAGENOME_SILVER_GRAPH = CHEST_IMAGENOME_SILVER_DATA / "scene_graph"
CHEST_IMAGENOME_SILVER_TRAIN_CSV = CHEST_IMAGENOME_SILVER_DATA / "splits/train.csv"
CHEST_IMAGENOME_SILVER_VALID_CSV = CHEST_IMAGENOME_SILVER_DATA / "splits/valid.csv"
CHEST_IMAGENOME_SILVER_TEST_CSV = CHEST_IMAGENOME_SILVER_DATA / "splits/test.csv"
##Gold
CHEST_IMAGENOME_GOLD_DATA = CHEST_IMAGENOME_DATA_DIR / "gold_dataset"
CHEST_IMAGENOME_GOLD_SPATIAL = CHEST_IMAGENOME_GOLD_DATA / "gold_object_attribute_with_coordinates.txt"
CHEST_IMAGENOME_GOLD_TEMPORAL = CHEST_IMAGENOME_GOLD_DATA / "gold_object_comparison_with_coordinates.txt"
